...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if ($stmt->execute()) {
            ...
            throw new Exception("Erro ao cadastrar a transportadora.");
        }
    } catch (Exception $e) {
        $error = $e->getMessage();
    }
...
<head>
    ...
    <style>
        ...
        .container {
            ...
            color: #2D893E;
            height: auto;
            overflow-y: auto; /* Habilita a rolagem dentro do container */
        }
...
<div class="container">
    ...
    <div class="content-footer">
        <a href="consulta_transportadoras.php">Ir para página de Consulta de Transportadoras</a>
    </div>
</div>
