...
<head>
    ...
    <title>Clientes - LicitaSis</title>
...
<div class="container">
    ...
    <div class="btn-container">
        <a href="cadastrar_clientes.php"><i class="fas fa-plus-circle"></i> Inserir Cliente</a>
        <a href="consultar_clientes.php"><i class="fas fa-search"></i> Consultar Clientes</a>
    </div>
</div>
