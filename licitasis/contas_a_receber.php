...
// Busca com filtro de pesquisa corrigida
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    try {
        ...
        $error = "Erro ao buscar todas as contas a receber: " . $e->getMessage();
    }
}
...
<title>Contas a Receber - LicitaSis</title>
...
<div class="container">
    ...
    <?php if (isset($totalGeralReceber)): ?>
        <div class="alert alert-success" style="text-align: center;">
            <i class="fas fa-dollar-sign"></i>
            <strong>Total Geral de Contas a Receber: R$ <?php echo number_format($totalGeralReceber, 2, ',', '.'); ?></strong>
        </div>
    <?php endif; ?>
    ...
    <form action="contas_a_receber.php" method="GET" class="search-bar">
    ...
    <?php elseif ($searchTerm): ?>
        <div class="alert alert-error" style="text-align: center;">
            ...
            Nenhuma conta a receber encontrada para o termo pesquisado.
        </div>
    <?php else: ?>
        <div class="alert alert-error" style="text-align: center;">
            <i class="fas fa-info-circle"></i>
            Nenhuma conta a receber cadastrada no sistema.
        </div>
    <?php endif; ?>
</div>

<!-- Modal para visualizar detalhes da conta a receber -->
<div id="editModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle" aria-describedby="modalDesc">
    <div class="modal-content">
        ...
        <h2 id="modalTitle">Detalhes da Conta a Receber</h2>
        <form method="POST" action="contas_a_receber.php" id="vendaForm">
...
<div id="confirmationModal" class="confirmation-modal" role="dialog" aria-modal="true">
    <div class="confirmation-modal-content">
        ...
        <p style="color: var(--warning-color); font-size: 0.9rem; margin-top: 1rem;">
            <i class="fas fa-info-circle"></i> Esta ação não poderá ser desfeita facilmente.
        </p>
        ...
        <div class="confirmation-buttons">
            ...
            <button type="button" class="btn-confirm" onclick="confirmReceived()">
...
<script>
    ...
    function openModal(id) {
        ...
        fetch('contas_a_receber.php?get_venda_id=' + id)
            ...
            .catch(error => {
                ...
                alert('Erro ao carregar os detalhes da conta a receber.');
                closeModal();
            });
    }
    ...
    document.querySelectorAll('.status-select').forEach(select => {
        select.addEventListener('change', function() {
            ...
            if (newStatus === 'Recebido' && previousStatus !== 'Recebido') {
                ...
                // Atualização direta para "Não Recebido"
