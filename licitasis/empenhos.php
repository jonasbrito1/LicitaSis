...
<head>
    ...
    <title>Empenhos - LicitaSis</title>
...
<div class="container">
    ...
    <div class="btn-container">
        <a href="cadastro_empenho.php"><i class="fas fa-plus-circle"></i> Inserir Empenho</a>
        <a href="consulta_empenho.php"><i class="fas fa-search"></i> Consultar Empenhos</a>
    </div>
</div>
